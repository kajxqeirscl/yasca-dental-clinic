      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="space-y-3">
            ...
            {(appointment.treatment_name || appointment.notes) && (
              <div className="pt-3 border-t space-y-3">
                {appointment.treatment_name && (
                  <div className="flex items-start gap-3">
                    <Activity className="w-5 h-5 text-gray-400 mt-0.5 shrink-0" />
                    <div>
                      <p className="text-sm text-gray-500">{t('appointments:detail.fields.treatment', 'İşlem (Tedavi)')}</p>
                      <p className="text-gray-900">{appointment.treatment_name}</p>
                    </div>
                  </div>
                )}
