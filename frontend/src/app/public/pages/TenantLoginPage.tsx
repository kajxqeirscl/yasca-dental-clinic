...
export default function TenantLoginPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Gerçek uygulamada `.yasca.com` veya lokalde `.localhost:5173`
    ...
    <div className="min-h-[80vh] flex items-center justify-center bg-[#fafafa] px-4">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <h2 className="text-3xl font-extrabold text-gray-900 mb-2">Kliniğinize Giriş Yapın</h2>
          <p className="text-gray-500 text-lg">
            Sisteme giriş yapmak için kliniğinize özel adresinizi (subdomain) girin.
          </p>
        </div>
        ...
        <div className="bg-white p-8 sm:p-10 rounded-3xl shadow-xl shadow-gray-200/50 border border-gray-100">
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              <label className="text-sm font-semibold text-gray-700">Klinik Adresi</label>
