...
// Kullanım: cd frontend ; node ../scripts/capture_screenshots.mjs
...
(async () => {
  ...
  await safe('login-submit', async () => {
    ...
    // Login formunun kaybolmasını / dashboard yüklenmesini bekle
